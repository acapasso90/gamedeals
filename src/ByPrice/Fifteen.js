...
useEffect(() => {
    let mounted = true;
    let apiURL = `https://www.cheapshark.com/api/1.0/deals?upperPrice=15&sortBy=${sort}&pageNumber=${page}`;
...
if (page === 0){
    return (
        <div className="GamesBelow">
            <h1 className="pageHeader"> Games currently below $15</h1> 
