...
export default function FreeBrowser(){
...
useEffect(() => {
    ...
    const options = {
      ...
      params: {platform: 'browser', category: genre},
      headers: {
...
if (loaded){
  if (gameData.status === undefined){
    return (
      <div className="GamesBelow">
          <h1> Currently Free-To-Play Browser games</h1>
  ...
  <div className="GamesBelow">
         ...
         <h3> Currently no free {genre} games on browser</h3>
